...
// rejected, not retained as an alias. It is qualified for native builds on
// windows/amd64 hosts.
const TargetX86_64WindowsGNU TargetProfileID = "x86_64-windows-gnu-ucrt"

// TargetX86_64LinuxGNU is the x86-64 Linux profile: glibc, LP64. It is
// qualified for native builds on linux/amd64 hosts.
