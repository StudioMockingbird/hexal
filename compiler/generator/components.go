...
// render model for this compilation.
...
// renderComponent executes one component template. A parse or execution
// failure is an internal compiler error: generation fails closed and returns
