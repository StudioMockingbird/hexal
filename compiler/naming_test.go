...
func TestPrivateValueNames(t *testing.T) {
	...
	source := "main: Int32 = 1 int: Int32 = 2 restrict: Int32 = 3 INT32_MAX: Int32 = 4 sw_v_score: Int32 = 5 " + longName + ": Int32 = 6"
	...
	for _, want := range []string{
		...
		"const int32_t sw_v_restrict = 3;",
		"const int32_t sw_v_INT32_MAX = 4;",
		"const int32_t sw_v_sw_v_score = 5;",
		"const int32_t sw_v_" + longName + " = 6;",
	} {
...
func TestReferencesUsePrivateValueNames(t *testing.T) {
	...
	for _, want := range []string{
		"int32_t sw_v_int = 1;",
		"sw_v_int = 2;",
		"const int32_t *const sw_v_pointer = &sw_v_int;",
