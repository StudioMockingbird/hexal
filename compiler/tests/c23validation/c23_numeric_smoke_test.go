...
// iteration generate C that gcc accepts.
...
// Runtime conformance: float-to-integer conversion truncates
...
// Runtime conformance: a signed type's MIN / -1 yields MIN and
...
// Runtime traps: dynamic conversion overflow, empty List
