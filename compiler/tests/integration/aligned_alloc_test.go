...
func TestAlignedAllocationCompiles(t *testing.T) {
	for _, source := range []string{
		...
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(13, align_of<Int32>())\n    defer h.free(p)\n    return ^p\nend\n",
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(13, 64)\n    defer h.free(p)\n    return ^p\nend\n",
		...
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(13, 1)\n    defer h.free(p)\n    return ^p\nend\n",
		// Structs and arrays allocate the same way.
		"type Point is struct mut x: Int32, mut y: Int32, end\nfun demo(h: Heap): Int32 do\n    let p: Ptr<mut Point> = h.allocate_aligned<Point>(Point(x = 1, y = 2), 64)\n    defer h.free(p)\n    return (^p).x\nend\n",
	} {
...
func TestConstantInvalidAlignmentIsRejected(t *testing.T) {
	assertRejects(t,
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(13, 0)\n    return ^p\nend\n",
		"alignment must be a non-zero power of two; got 0")
	assertRejects(t,
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(13, 3)\n    return ^p\nend\n",
		"alignment must be a non-zero power of two; got 3")
	assertRejects(t,
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(13, 48)\n    return ^p\nend\n",
...
func TestAlignedAllocationKeepsOrdinaryDiagnostics(t *testing.T) {
	...
	assertRejects(t,
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(true, 64)\n    return ^p\nend\n",
		"allocation initializer requires Int32; got Bool")
	assertRejects(t,
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(13)\n    return ^p\nend\n",
		"allocate_aligned expects 2 arguments (initial, alignment)")
	assertRejects(t,
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned(13, 64)\n    return ^p\nend\n",
		"allocate_aligned requires exactly one type argument")
	assertRejectsAnyDiagnostic(t,
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Atomic<Int32>> = h.allocate_aligned<Atomic<Int32>>(Atomic<Int32>(0), 64)\n    return 0\nend\n",
...
func TestAlignedAllocationEvaluatesOperandsOnceInOrder(t *testing.T) {
	source := "fun initial(): Int32 do\n    return 13\nend\n" +
		...
		"fun demo(h: Heap): Int32 do\n    let p: Ptr<mut Int32> = h.allocate_aligned<Int32>(initial(), requested())\n    defer h.free(p)\n    return ^p\nend\n"
