...
func TestSliceFromPointerCompiles(t *testing.T) {
	source := "fun total(data: Ptr<Int32>, count: Size): Int32 do\n    unsafe do\n        let items: Slice<Int32> = Slice<Int32>.from_pointer(data, count)\n        let mut sum: Int32 = 0\n        for value in items do\n            sum = sum + value\n        end\n        return sum\n    end\nend\n"
...
func TestSliceFromPointerRequiresUnsafeBlock(t *testing.T) {
	sources := []string{
		...
		"fun bad(data: Ptr<mut Int32>, count: Size) do\n    let items: Slice<mut Int32> = Slice<mut Int32>.from_pointer(data, count)\nend\n",
	}
...
func TestSliceFromPointerRejectsStringPointee(t *testing.T) {
	...
	source := "fun bad(data: Ptr<String>, count: Size) do\n    unsafe do\n        let items: Slice<String> = Slice<String>.from_pointer(data, count)\n    end\nend\n"
	result := compileSource(source)
...
func TestFromPointerAcceptsAllRoots(t *testing.T) {
	accepted := []string{
		"fun f() do\n    let mut value: Int32 = 1\n    unsafe do\n        let view: Slice<Int32> = Slice<Int32>.from_pointer(@value, 1)\n    end\nend\n",
		...
		"fun f() do\n    let mut value: Int32 = 1\n    let mut p: Ptr<Int32> = @value\n    let mut q: Ptr<Int32> = p\n    unsafe do\n        let view: Slice<Int32> = Slice<Int32>.from_pointer(q, 1)\n        p = @value\n        let view2: Slice<Int32> = Slice<Int32>.from_pointer(p, 1)\n    end\nend\n",
