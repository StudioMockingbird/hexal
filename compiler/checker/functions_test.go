...
func TestFunctionDeclarationProducesCheckedIR(t *testing.T) {
	checked := requireAccepted(t, "fun adder(dx: Int32, dy: Int32): Int32\n    return dx + dy\nend\n")
...
func TestCheckedCallAndFunctionReferenceNodes(t *testing.T) {
	checked := requireAccepted(t, "fun identity(value: Int32): Int32\n    return value\nend\ncallback: Fun<(Int32) : Int32> = identity\ntotal: Int32 = identity(7)\n")
...
func TestNoReturnCallStatementIsChecked(t *testing.T) {
	checked := requireAccepted(t, "fun reset(counter: MutPtr<Int32>)\n    counter.value = 0\nend\nmut count: Int32 = 1\nreset(ref count)\n")
...
func TestSelfRecursionResolves(t *testing.T) {
	requireAccepted(t, "fun factorial(value: Int32): Int32\n    return value * factorial(value - 1)\nend\n")
}

func TestEarlierFunctionIsVisible(t *testing.T) {
	requireAccepted(t, "fun double(value: Int32): Int32\n    return value + value\nend\nfun quadruple(value: Int32): Int32\n    return double(double(value))\nend\n")
}
...
func TestLocalsAndMutableLocalsAreAllowed(t *testing.T) {
	requireAccepted(t, "fun scoped(seed: Int32): Int32\n    mut total: Int32 = seed\n    total = total + 1\n    return total\nend\n")
}
...
func TestArgumentsUseParameterExpectedTypes(t *testing.T) {
	requireAccepted(t, "fun small(value: UInt8): UInt8\n    return value\nend\nok: UInt8 = small(200)\n")
	requireDiagnostic(t,
...
func TestArgumentsUsePointerWeakening(t *testing.T) {
	requireAccepted(t, "fun peek(source: Ptr<Int32>): Int32\n    return source.value\nend\nmut score: Int32 = 1\ntotal: Int32 = peek(ref score)\n")
}
...
func TestSupportedFunPositionsAreAccepted(t *testing.T) {
	requireAccepted(t, "fun identity(value: Int32): Int32\n    return value\nend\nmodule_level: Fun<(Int32) : Int32> = identity\nfun higher(callback: Fun<(Fun<(Int32) : Int32>)>, value: Int32): Int32\n    local: Fun<(Int32) : Int32> = identity\n    return local(value)\nend\n")
}
...
func TestFunctionNameIsAssignableToAnIdenticalFunType(t *testing.T) {
	requireAccepted(t, "fun adder(dx: Int32): Int32\n    return dx\nend\nmut handler: Fun<(Int32) : Int32> = adder\nhandler = adder\n")
}
...
func TestMethodDeclarationProducesCheckedIR(t *testing.T) {
	checked := requireAccepted(t, point+"impl Point.length_squared(): Int32\n    return self.x * self.x + self.y * self.y\nend\n")
...
func TestMethodControlFlowUsesStructuredScopesAndFlow(t *testing.T) {
	requireAccepted(t, point+"impl Point.classify(value: Int32): Int32\n"+
		"    if value > 0\n"+
		"        return value\n"+
		"    else\n"+"        return 0\n"+"    end\n"+"end\n")
	requireDiagnostic(t, point+"impl Point.partial(value: Int32): Int32\n"+"    if value > 0\n"+"        return value\n"+"    end\n"+"end\n",
...
func TestSelfCannotBeAssigned(t *testing.T) {
	requireDiagnostic(t, point+"impl MutPtr<Point>.reset()\n    self = self\nend\n",
		"cannot assign to self; self is a fixed binding")
	requireDiagnostic(t, point+"impl Point.reset()\n    self = self\nend\n",
		"cannot assign to self; self is a fixed binding")
}
...
func TestValueReceiverSelfIsFixed(t *testing.T) {
	requireDiagnostic(t, point+"impl Point.moved(dx: Int32): Point\n    self.x = self.x + dx\n    return self\nend\n",
		"cannot assign to read-only member self.x")
	requireAccepted(t, point+"impl Point.moved(dx: Int32): Point\n    mut result: Point = self\n    result.x = result.x + dx\n    return result\nend\n")
}

func TestPtrReceiverSelfIsReadOnly(t *testing.T) {
	requireAccepted(t, point+"impl Ptr<Point>.is_origin(): Bool\n    return self.x == 0\nend\n")
	requireDiagnostic(t, point+"impl Ptr<Point>.reset()\n    self.x = 0\nend\n",
		"cannot assign to read-only member self.x")
}
...
func TestReceiverAdaptationRules(t *testing.T) {
	// exact target type
	requireAccepted(t, point+"impl Point.length_squared(): Int32\n    return self.x * self.x\nend\n"+
	...
	requireAccepted(t, point+"impl MutPtr<Point>.translate(dx: Int32, dy: Int32)\n    self.x = self.x + dx\nend\n"+
		"mut here: Point = Point { x = 0, y = 0, }\nhere.translate(5, 5)\n")
}

func TestFixedReceiverCannotReachAMutPtrMethod(t *testing.T) {
	requireDiagnostic(t, point+"impl MutPtr<Point>.translate(dx: Int32, dy: Int32)\n    self.x = self.x + dx\nend\n"+
...
func TestMethodsAreNotValues(t *testing.T) {
	requireDiagnostic(t, point+"impl Point.length_squared(): Int32\n    return self.x * self.x\nend\n"+
...
func TestImplTargetMustBeANominalObject(t *testing.T) {
	requireDiagnostic(t, "impl Int32.doubled(): Int32\n    return 0\nend\n",
		"Int32 is not a nominal object type; impl requires an object")
	requireDiagnostic(t, "impl Ptr<Int32>.doubled(): Int32\n    return 0\nend\n",
		"Ptr<Int32> is not a nominal object type; impl requires an object")
	requireDiagnostic(t, "impl Fun<(Int32) : Int32>.doubled(): Int32\n    return 0\nend\n",
...
func TestNullableFunctionSignaturesAndReturns(t *testing.T) {
	requireAccepted(t, "fun find_none(): Ptr<Int32> | Nil\n    return nil\nend\n")
...
func TestNullableArgumentsToNullableParameters(t *testing.T) {
	requireAccepted(t, "fun probe(maybe: Ptr<Int32> | Nil): Ptr<Int32> | Nil\n    return maybe\nend\n"+
		"mut value: Int32 = 1\nwriter: MutPtr<Int32> = ref value\n"+
...
func TestMethodSignaturesAcceptNullableParameterAndReturnTypes(t *testing.T) {
	requireAccepted(t, "type Node = { value: Int32, mut next: MutPtr<Node> | Nil, }\n"+
		"impl Node.set_next(next: MutPtr<Node> | Nil): MutPtr<Node> | Nil\n    return next\nend\n")
}
...
func TestNullableFunctionPointerRequiresNarrowingBeforeCall(t *testing.T) {
	...
	requireAccepted(t, "fun identity(value: Int32): Int32\n    return value\nend\n"+
		"fun invoke(callback: Fun<(Int32) : Int32> | Nil, value: Int32): Int32\n"+
		"    if callback != nil\n        return callback(value)\n    end\n    return 0\nend\n")
}
...
func TestImplTargetCannotBeNullable(t *testing.T) {
	requireDiagnostic(t, "type Node = { value: Int32, mut next: MutPtr<Node> | Nil, }\n"+
		"impl MutPtr<Node> | Nil.read(): Int32\n    return 0\nend\n",
...
func TestMethodCallProducesCheckedIR(t *testing.T) {
	checked := requireAccepted(t, point+"impl MutPtr<Point>.translate(dx: Int32)\n    self.x = self.x + dx\nend\n"+
		"mut here: Point = Point { x = 0, y = 0, }\nhere.translate(5)\n")
	statement, ok := checked.Statements[2].(CallStatement)
	if !ok {
		t.Fatalf("statement = %T, want CallStatement", checked.Statements[2])
